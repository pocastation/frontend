...
// 광학 정렬로 아래로 2px 내린다 — 근거는 Header.tsx의 BellIcon 주석(#711).
function BellIcon() {
  return (
    <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" aria-hidden="true" className="translate-y-[2px]">
