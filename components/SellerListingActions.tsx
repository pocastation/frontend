 ...
 *
 * <p>예전에는 둘 다 <b>마이페이지 「판매 중인 상품」 탭에만</b> 있었다. 자기 매물 상세를 열면
    ...
    <div className={viewport === "desktop" ? "mt-5 border-t border-border pt-5" : "mt-3.5 border-t border-border pt-3"}>
      ...
      <p className="mb-2.5 text-[11.5px] leading-relaxed text-text-3">
        {isInstant ? (
          ...
          <>
            내가 올린 판매글이에요 · <b className="font-bold text-text-1">{offerCount}명</b>이 제안했어요
          </>
        ) : (
          <>내가 올린 판매글이에요 · 아직 제안이 없어 가격을 바꿀 수 있어요</>
        )}
