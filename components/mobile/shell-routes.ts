...
//
// 판매 등록도 전역 Header는 접는다. #704부터 `app/auctions/new/layout.tsx`가 홈과 같은
// MobileShell 헤더를 대신 그려 중복 없이 로고·검색·알림을 유지한다. 위저드 단계 머리는 그 아래에
// 붙이고, 하단탭은 등록 흐름에 집중하도록 별도 목록에서 계속 숨긴다.
//
