// 실제 거래 성사 이벤트는 bid 도메인이 생겨야 의미가 생긴다(§1 신뢰 원칙 — 없는 활동을
// 있는 것처럼 보여주면 안 됨) — 그 전까지는 레이아웃만 미리 잡아둔 예시 데이터임을 명시한다.
const DEMO_ITEMS = [
  "정국 Proof 위버스 특전 포카 — ₩44,000 거래 성사",
  "NewJeans 민지 슬로건 — ₩28,500 거래 성사",
  "SEVENTEEN 승관 포토카드 — ₩41,000 거래 성사",
  "IVE 안유진 키링 — ₩19,000 거래 성사",
  "Stray Kids 방찬 포토카드 — ₩55,000 거래 성사",
];
